...
export default function OnboardingScreen3({
  ...
  function handleFinishOnboarding() {
    // Do NOT mark onboarding complete here (that belongs to user signup flow).
    // Just call parent onSignup which the carousel wired to mark intro-seen and navigate.
...
// }: ScreenProps) {
//   const { width } = useWindowDimensions();
//   const { setOnboardingComplete, lastStep, setHasSeenIntro } = useAuthStore();
//   const router = useRouter();
...
//     if (onSignup) onSignup();
//     // router.replace((lastStep as any) || '/(auth)/signup/emailPassword'); // or '/(main)/home' if user profile complete
//   };

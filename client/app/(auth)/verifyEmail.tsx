...
//       <TouchableOpacity className="px-4 py-3 mb-3 rounded-lg bg-emerald-500" onPress={iVerified}>
//         <Text className="font-semibold text-white">{"I've verified"}</Text>
//       </TouchableOpacity>

//       <TouchableOpacity className="px-4 py-3 bg-gray-200 rounded-lg" onPress={resend}>
